...
public partial class EnemyStats : Resource
{
    ...
    [Export] public float ContactDamage { get; set; } = 1; // The amount of damage the enemy deals to the player on contact. Hihher values mean more damage to the player.
